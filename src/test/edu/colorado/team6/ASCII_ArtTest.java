...
class ASCII_ArtTest {
    @Test
    public void testValuesInHashMap() {
        ...
        assertEquals(champagne, ASCII_Art.asciiArt.get("Champagne"));
        assertEquals(nuke, ASCII_Art.asciiArt.get("Nuke"));
        assertEquals(pie, ASCII_Art.asciiArt.get("Pie"));
        assertEquals(poo, ASCII_Art.asciiArt.get("Poo"));
        assertEquals(ship, ASCII_Art.asciiArt.get("Ship"));
